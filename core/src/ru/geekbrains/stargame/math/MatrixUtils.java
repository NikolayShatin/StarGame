...
public class MatrixUtils {
    ...
    public static void calcTransitionMatrix(Matrix4 mat, Rect src, Rect dst) {
        //скалирование по оси x и у для понимания, насколько по осям x и y уменьшать или увеличивать значение
        float scaleX = dst.getWidth() / src.getWidth(); // соотношение ширины прямоугольника назначения к источнику
